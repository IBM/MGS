...
class Tissue 
{
 public:
  ...
  void generateHistogram(int&, int**&, SegmentSpace* segmentSpace=0, TouchSpace* touchSpace=0);
  ...
  //void getHistogram(int**& histogram, double*& minXYZ, double*& maxXYZ, double*& binwidth, int*& nbinsXYZ, int& total);
  void getLocalHistogram(int**& histogram, double*& minXYZ, double*& maxXYZ, double*& binwidth, int*& nbinsXYZ);
