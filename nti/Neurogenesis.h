...
class Neurogenesis {
 ...
 public:
  Neurogenesis(int rank, int size, int nThreads, std::string statsFileName, 
	       std::string parsFileName, bool stdout, bool fout, int branchType,  std::map<std::string, BoundingSurfaceMesh*>& boundingSurfaceMap);
  ~Neurogenesis();
 ...
 private:
  ...
  bool touchesAnotherSeg(int threadID, NeurogenSegment* seg_p, NeurogenParams* params_p);
  bool touchesAnotherSegWithExceptions(int threadID, NeurogenSegment* seg_p, NeurogenParams* params_p);
  bool withinMinimumStemAngleOfAnotherSeg(int threadID, NeurogenSegment* seg_p, double relaxationFactor, NeurogenParams* params_p);
  bool checkIntersect2D(int threadID, NeurogenSegment* newSeg);
  void segmentsNear(int threadID, ShallowArray<NeurogenSegment*>& SegTouchVec, NeurogenSegment* seg_p, NeurogenParams* params_p);
  bool checkBorders(NeurogenSegment* seg_p);
  bool checkRadius(NeurogenSegment* seg_p, NeurogenParams* params_p);
  bool checkTouchAndRelax(int threadID, NeurogenSegment* seg_p, NeurogenParams* params_p);
