...
inline void NeuroDevParser::Option::setType(Type type) {
  fieldType = type;
}

inline bool NeuroDevParser::Option::operator==(const NeuroDevParser::Option &option) {
  return(getShortName() == option.getShortName() &&
	 getLongName() == option.getLongName() &&
	 getType() == option.getType());
}

inline NeuroDevParser::Parameter::Parameter(const NeuroDevParser::Option &option, const std::string &value) :
...
inline NeuroDevParser::Parameter::Parameter(const NeuroDevParser::Option &option) :
  fieldOption(option), fieldValue("") {
}
inline NeuroDevParser::Parameter::~Parameter() {}
inline NeuroDevParser::Option const & NeuroDevParser::Parameter::getOption() const {
  return(fieldOption);
}
inline void NeuroDevParser::Parameter::setOption(const NeuroDevParser::Option &option) {
  fieldOption = option;
}
...
inline NeuroDevParser::Parameter &NeuroDevParser::Parameter::operator=(const NeuroDevParser::Parameter &parameter) {
