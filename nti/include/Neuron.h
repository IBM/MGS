...
class Neuron
{
   public:
      ...
      Segment* loadBinary(FILE*, Segment*, Tissue*, const int neuronIndex, FILE*, FILE*);
      Segment* loadText(FILE*, Segment*, Tissue*, const int neuronIndex, FILE*, FILE*, int layer, int morphologicalType, int electrophysiologicalType, double x, double y, double z, char offsetType);
      ...
      void setSegmentsBegin(Segment* segmentsBegin) {_segmentsBegin=segmentsBegin;}
