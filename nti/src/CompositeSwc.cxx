...
CompositeSwc::CompositeSwc(const char* tissueFileName, const char* outFileName,
                           double sampleRate, bool multicolor) {
            ...
            while (swcFile.good()) {
              ...
              if (swcLine != "" && swcLine.at(0) != '#') {
                ...
                if (multicolor)
                  ...
                  type = atoi(swcResults.at(1).c_str());
                int parent = atoi(swcResults.at(6).c_str());
                if (parent > 0)
                  parent += root;
                else
                  type = DEFAULT_REPLACEMENT_SOMA_TYPE;
                outFile << id << " " << type << " ";
