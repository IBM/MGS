...
def plot_case9_adv():
    ...
    ### row 3
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder2Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder2V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder2Ca.dat')
    if (os.path.isfile(myFile)):
      channelNames=["Ca"]
      nCols = len(channelNames)
    ...
    ### row 1
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder3Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder3V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder3Ca.dat')
    channelNames=["Ca"]
    nCols = len(channelNames)
    ...
    ### row 2
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder4Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder4V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder4Ca.dat')
    if (os.path.isfile(myFile)):
      channelNames=["Ca"]
      nCols = len(channelNames)
    ...
    ### row 3
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder5Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder5V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen11xbrOrder5Ca.dat')
    if (os.path.isfile(myFile)):
      channelNames=["Ca"]
      nCols = len(channelNames)
    ...
    ### row 1
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder3Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder3V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder3Ca.dat')
    channelNames=["Ca"]
    nCols = len(channelNames)
    ...
    ### row 2
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder4Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder4V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder4Ca.dat')
    if (os.path.isfile(myFile)):
      channelNames=["Ca"]
      nCols = len(channelNames)
    ...
    ### row 3
    ## For 1 file
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder5Currents.dat')
    ...
    ## For 1 file
    ### first y-axis (Voltage)
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder5V.dat')
    #file=open(myFile)
    #lines=file.readlines()
    #channelNames = re.split(",",lines[1])
    #del channelNames[-1], channelNames[0]
    ...
    ### second y-axis
    ## Calcium
    myFile = folder+'/'+getFile(folder,'basalDen21xbrOrder5Ca.dat')
    if (os.path.isfile(myFile)):
      channelNames=["Ca"]
      nCols = len(channelNames)
