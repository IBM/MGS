...
seed=10000
trials=$(seq 0 1 0)
changeFile="CannabinoidPlasticity.gsl"

# If 1D search - use ERROR_is_2D when is 2D or ERROR_not_in_use when not in use.
variables=`echo $(seq 0.000005 0.000005 0.000050)`
additionalVariables_1=(ERROR_not_in_use)
additionalVariables_2=(ERROR_not_in_use)
additionalVariables_3=(ERROR_not_in_use)

# If 2D search - use ERROR_is_1D when is 1D or ERROR_not_in_use when not in use.
variables_X=ERROR_is_1D
variables_Y=ERROR_is_1D
additionalVariables_1_X=ERROR_is_1D # These should be of same size as above. E.g. (`echo $(seq 0.0 0.08334 0.834)`)
additionalVariables_2_X=ERROR_is_1D
additionalVariables_3_X=ERROR_is_1D
additionalVariables_1_Y=ERROR_is_1D
additionalVariables_2_Y=ERROR_is_1D
additionalVariables_3_Y=ERROR_is_1D
