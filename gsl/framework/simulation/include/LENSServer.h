...
class LENSServer : public TriggerableBase
{
   ...
   private:
      ...
      void sendComposerError(const char* facname, const char* a, 
			     const char* b, int i, int errtype);

      // send parameter description
      void sendPDescription(const char* type1,const char* type2, 
			    std::vector< std::vector< 
			    std::pair< std::string, DataItem*> > > const & pd);
...
inline int LENSServer::isConnected()
{
   return(_connected);
}
...
inline void LENSServer:: sendComposerError(const char* facName, const char* expectedType,const char* param2,int i, int errType)
{
...
inline void LENSServer::sendPDescription(const char* type1,const char* type2, std::vector< std::vector< std::pair< std::string, DataItem*> > > const & pd)
{
