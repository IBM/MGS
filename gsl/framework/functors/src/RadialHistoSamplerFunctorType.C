...
std::string RadialHistoSamplerFunctorType::getName()
{
   return std::string("RadialHistoSampler");
}


std::string RadialHistoSamplerFunctorType::getDescription()
{   
...
Functor* RadialHistoSamplerFunctorType::getFunctor()
{
   Functor* f = new RadialHistoSamplerFunctor;
