...
RadialSamplerFunctorType::RadialSamplerFunctorType() {}

void RadialSamplerFunctorType::getFunctor(std::unique_ptr<Functor> & r_aptr)
{
   r_aptr.reset(new RadialSamplerFunctor());
}


std::string RadialSamplerFunctorType::getName()
{
   return std::string("RadialSampler");
}


std::string RadialSamplerFunctorType::getDescription()
{   
   return std::string(SampFctr1Functor::_category);
}


void RadialSamplerFunctorType::getQueriable(
...
Functor* RadialSamplerFunctorType::getFunctor()
{
   Functor* f = new RadialSamplerFunctor;
