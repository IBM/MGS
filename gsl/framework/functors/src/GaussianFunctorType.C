...
GaussianFunctorType::GaussianFunctorType() {}

void GaussianFunctorType::getFunctor(std::unique_ptr<Functor> & r_aptr)
{
   r_aptr.reset(new GaussianFunctor());
}


std::string GaussianFunctorType::getName()
{
   return std::string("Gaussian");
}


std::string GaussianFunctorType::getDescription()
{
   return std::string(Functor::_category);
}


void GaussianFunctorType::getQueriable(
...
Functor* GaussianFunctorType::getFunctor()
{
   Functor* f = new GaussianFunctor;
