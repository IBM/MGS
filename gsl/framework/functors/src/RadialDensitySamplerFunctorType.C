...
RadialDensitySamplerFunctorType::RadialDensitySamplerFunctorType() {}

void RadialDensitySamplerFunctorType::getFunctor(std::unique_ptr<Functor> & r_aptr)
{
   r_aptr.reset(new RadialDensitySamplerFunctor());
}


std::string RadialDensitySamplerFunctorType::getName()
{
   return std::string("RadialDensitySampler");
}


std::string RadialDensitySamplerFunctorType::getDescription()
{
   return std::string(SampFctr1Functor::_category);
}


void RadialDensitySamplerFunctorType::getQueriable(
...
Functor* RadialDensitySamplerFunctorType::getFunctor()
{
   Functor* f = new RadialDensitySamplerFunctor;
