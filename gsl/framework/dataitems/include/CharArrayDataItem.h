...
#ifndef CHARARRAYDATAITEM_H
#define CHARARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class CharArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      CharArrayDataItem();
      CharArrayDataItem(const CharArrayDataItem& DI);
      CharArrayDataItem(std::vector<int> const & dimensions);
      CharArrayDataItem(ShallowArray<char> const & data);
      ~CharArrayDataItem();
      ...
      const std::vector<char>* getCharVector() const;
      std::vector<char>* getModifiableCharVector();
