...
#ifndef INTARRAYDATAITEM_H
#define INTARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class IntArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      IntArrayDataItem();
      IntArrayDataItem(const IntArrayDataItem& DI);
      IntArrayDataItem(std::vector<int> const & dimensions);
      IntArrayDataItem(ShallowArray<int> const & data);
      ~IntArrayDataItem();
      ...
      std::vector<int>* getModifiableIntVector();
