...
#ifndef UNSIGNEDINTARRAYDATAITEM_H
#define UNSIGNEDINTARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class UnsignedIntArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      UnsignedIntArrayDataItem();
      UnsignedIntArrayDataItem(const UnsignedIntArrayDataItem& DI);
      UnsignedIntArrayDataItem(std::vector<int> const & dimensions);
      UnsignedIntArrayDataItem(ShallowArray<unsigned int> const & data);
      ~UnsignedIntArrayDataItem();
      ...
      const std::vector<unsigned int>* getUnsignedIntVector() const;
      std::vector<unsigned int>* getModifiableUnsignedIntVector();
