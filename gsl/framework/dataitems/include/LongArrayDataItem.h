...
#ifndef LONGARRAYDATAITEM_H
#define LONGARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class LongArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      LongArrayDataItem();
      LongArrayDataItem(const LongArrayDataItem& DI);
      LongArrayDataItem(std::vector<int> const & dimensions);
      LongArrayDataItem(ShallowArray<long> const & data);
      ~LongArrayDataItem();
      ...
      const std::vector<long>* getLongVector() const;
      std::vector<long>* getModifiableLongVector();
