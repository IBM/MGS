...
#ifndef SIGNEDCHARARRAYDATAITEM_H
#define SIGNEDCHARARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class SignedCharArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      SignedCharArrayDataItem();
      SignedCharArrayDataItem(const SignedCharArrayDataItem& DI);
      SignedCharArrayDataItem(std::vector<int> const & dimensions);
      SignedCharArrayDataItem(ShallowArray<signed char> const & data);
      ~SignedCharArrayDataItem();
      ...
      const std::vector<signed char>* getSignedCharVector() const;
      std::vector<signed char>* getModifiableSignedCharVector();
