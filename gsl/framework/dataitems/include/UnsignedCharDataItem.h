...
#ifndef UNSIGNEDCHARDATAITEM_H
#define UNSIGNEDCHARDATAITEM_H
#include "Copyright.h"

#include "NumericDataItem.h"

class UnsignedCharDataItem : public NumericDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      UnsignedCharDataItem(unsigned char data = 0);
      UnsignedCharDataItem(const UnsignedCharDataItem& DI);
