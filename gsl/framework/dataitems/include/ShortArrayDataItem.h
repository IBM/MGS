...
//
// =============================================================================
#ifndef SHORTARRAYDATAITEM_H
#define SHORTARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class ShortArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      ShortArrayDataItem();
      ShortArrayDataItem(const ShortArrayDataItem& DI);
      ShortArrayDataItem(std::vector<int> const & dimensions);
      ShortArrayDataItem(ShallowArray<short> const & data);
      ~ShortArrayDataItem();
      ...
      const std::vector<short>* getShortVector() const;
      std::vector<short>* getModifiableShortVector();
