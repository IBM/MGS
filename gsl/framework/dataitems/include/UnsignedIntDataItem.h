...
//
// =============================================================================
#ifndef UNSIGNEDINTDATAITEM_H
#define UNSIGNEDINTDATAITEM_H
#include "Copyright.h"

#include "NumericDataItem.h"

class UnsignedIntDataItem : public NumericDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      UnsignedIntDataItem(unsigned int data = 0);
      UnsignedIntDataItem(const UnsignedIntDataItem& DI);
