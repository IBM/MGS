...
#ifndef BOOLARRAYDATAITEM_H
#define BOOLARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class BoolArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Concomplexors
      BoolArrayDataItem();
      BoolArrayDataItem(const BoolArrayDataItem& DI);
      BoolArrayDataItem(std::vector<int> const &dimensions);
      BoolArrayDataItem(ShallowArray<bool> const & data);
      ~BoolArrayDataItem();
      ...
      const std::vector<bool>* getBoolVector() const;
      std::vector<bool>* getModifiableBoolVector();
