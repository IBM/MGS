...
#ifndef UNSIGNEDCHARARRAYDATAITEM_H
#define UNSIGNEDCHARARRAYDATAITEM_H
#include "Copyright.h"

#include "NumericArrayDataItem.h"
#include "ShallowArray.h"

class UnsignedCharArrayDataItem : public NumericArrayDataItem
{
   private:
   ...
   public:
      ...
      // Constructors
      UnsignedCharArrayDataItem();
      UnsignedCharArrayDataItem(const UnsignedCharArrayDataItem& DI);
      UnsignedCharArrayDataItem(std::vector<int> const & dimensions);
      UnsignedCharArrayDataItem(ShallowArray<unsigned char> const & data);
      ~UnsignedCharArrayDataItem();
      ...
      const std::vector<unsigned char>* getUnsignedCharVector() const;
      std::vector<unsigned char>* getModifiableUnsignedCharVector();
