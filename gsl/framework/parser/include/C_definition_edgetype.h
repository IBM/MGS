...
#ifndef C_definition_edgetype_H
#define C_definition_edgetype_H
#include "Copyright.h"
...
class C_definition_edgetype : public C_definition
{
   public:
      C_definition_edgetype(const C_definition_edgetype&);
      C_definition_edgetype(C_declarator *, C_argument *,
