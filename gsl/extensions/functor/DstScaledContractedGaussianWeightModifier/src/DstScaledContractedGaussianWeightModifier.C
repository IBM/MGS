...
std::auto_ptr<ParameterSet> DstScaledContractedGaussianWeightModifier::userExecute(LensContext* CG_c) 
{
...
void DstScaledContractedGaussianWeightModifier::duplicate(std::auto_ptr<DstScaledContractedGaussianWeightModifier>& dup) const
{
   dup.reset(new DstScaledContractedGaussianWeightModifier(*this));
}

void DstScaledContractedGaussianWeightModifier::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new DstScaledContractedGaussianWeightModifier(*this));
}

void DstScaledContractedGaussianWeightModifier::duplicate(std::auto_ptr<CG_DstScaledContractedGaussianWeightModifierBase>& dup) const
{
   dup.reset(new DstScaledContractedGaussianWeightModifier(*this));
}
