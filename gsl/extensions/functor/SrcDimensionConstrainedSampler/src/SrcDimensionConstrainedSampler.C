...
void SrcDimensionConstrainedSampler::duplicate(std::auto_ptr<SrcDimensionConstrainedSampler>& dup) const
{
   dup.reset(new SrcDimensionConstrainedSampler(*this));
}

void SrcDimensionConstrainedSampler::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new SrcDimensionConstrainedSampler(*this));
}

void SrcDimensionConstrainedSampler::duplicate(std::auto_ptr<CG_SrcDimensionConstrainedSamplerBase>& dup) const
{
   dup.reset(new SrcDimensionConstrainedSampler(*this));
}
