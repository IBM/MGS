...
void GetPreNodeIndex::duplicate(std::auto_ptr<GetPreNodeIndex>& dup) const
{
   dup.reset(new GetPreNodeIndex(*this));
}

void GetPreNodeIndex::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new GetPreNodeIndex(*this));
}

void GetPreNodeIndex::duplicate(std::auto_ptr<CG_GetPreNodeIndexBase>& dup) const
{
   dup.reset(new GetPreNodeIndex(*this));
}
