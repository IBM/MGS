...
std::auto_ptr<ParameterSet> DstScaledGaussianWeightModifier::userExecute(LensContext* CG_c) 
{
...
void DstScaledGaussianWeightModifier::duplicate(std::auto_ptr<DstScaledGaussianWeightModifier>& dup) const
{
   dup.reset(new DstScaledGaussianWeightModifier(*this));
}

void DstScaledGaussianWeightModifier::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new DstScaledGaussianWeightModifier(*this));
}

void DstScaledGaussianWeightModifier::duplicate(std::auto_ptr<CG_DstScaledGaussianWeightModifierBase>& dup) const
{
   dup.reset(new DstScaledGaussianWeightModifier(*this));
}
