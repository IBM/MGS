...
class BidirectConnectNodeSetsFunctor : public CG_BidirectConnectNodeSetsFunctorBase
{
   public:
      ...
      virtual void duplicate(std::auto_ptr<BidirectConnectNodeSetsFunctor>& dup) const;
      virtual void duplicate(std::auto_ptr<Functor>& dup) const;
      virtual void duplicate(std::auto_ptr<CG_BidirectConnectNodeSetsFunctorBase>& dup) const;
   private:
