...
void RandomDispersalLayout::duplicate(std::auto_ptr<RandomDispersalLayout>& dup) const
{
   dup.reset(new RandomDispersalLayout(*this));
}

void RandomDispersalLayout::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new RandomDispersalLayout(*this));
}

void RandomDispersalLayout::duplicate(std::auto_ptr<CG_RandomDispersalLayoutBase>& dup) const
{
   dup.reset(new RandomDispersalLayout(*this));
}
