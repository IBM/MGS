...
void GradientLayout::duplicate(std::auto_ptr<GradientLayout>& dup) const
{
   dup.reset(new GradientLayout(*this));
}

void GradientLayout::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new GradientLayout(*this));
}

void GradientLayout::duplicate(std::auto_ptr<CG_GradientLayoutBase>& dup) const
{
   dup.reset(new GradientLayout(*this));
}
