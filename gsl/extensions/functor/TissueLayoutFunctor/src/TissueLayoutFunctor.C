...
void TissueLayoutFunctor::duplicate(std::auto_ptr<TissueLayoutFunctor>& dup) const
{
   dup.reset(new TissueLayoutFunctor(*this));
}

void TissueLayoutFunctor::duplicate(std::auto_ptr<Functor>& dup) const
{
   dup.reset(new TissueLayoutFunctor(*this));
}

void TissueLayoutFunctor::duplicate(std::auto_ptr<CG_TissueLayoutFunctorBase>& dup) const
{
   dup.reset(new TissueLayoutFunctor(*this));
}
