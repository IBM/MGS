...
class GatedThalamicUnitDataCollector : public CG_GatedThalamicUnitDataCollector
{
   public:
      ...
      virtual void getNodeIndices(const CustomString& CG_direction, const CustomString& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_GatedThalamicUnitDataCollectorInAttrPSet* CG_inAttrPset, CG_GatedThalamicUnitDataCollectorOutAttrPSet* CG_outAttrPset);
