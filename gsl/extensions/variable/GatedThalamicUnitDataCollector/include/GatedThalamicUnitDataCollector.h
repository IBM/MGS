...
class GatedThalamicUnitDataCollector : public CG_GatedThalamicUnitDataCollector
{
   public:
      ...
      virtual void duplicate(std::auto_ptr<GatedThalamicUnitDataCollector>& dup) const;
      virtual void duplicate(std::auto_ptr<Variable>& dup) const;
      virtual void duplicate(std::auto_ptr<CG_GatedThalamicUnitDataCollector>& dup) const;
