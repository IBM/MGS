...
class CalciumDisplay : public CG_CalciumDisplay
{
   public:
      ...
      virtual void setUpPointers(const String& CG_direction, const String& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_CalciumDisplayInAttrPSet* CG_inAttrPset, CG_CalciumDisplayOutAttrPSet* CG_outAttrPset);
      CalciumDisplay();
