...
#include "Lens.h"
#include "ChannelNas_STR_MSN_mouse.h"
...
void ChannelNas_STR_MSN_mouse::update(RNG& rng) 
{
...
void ChannelNas_STR_MSN_mouse::initialize(RNG& rng) 
{
  assert(branchData);
...
ChannelNas_STR_MSN_mouse::~ChannelNas_STR_MSN_mouse() 
{
}
