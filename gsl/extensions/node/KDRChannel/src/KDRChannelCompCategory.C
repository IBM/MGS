...
#include "Lens.h"
#include "KDRChannelCompCategory.h"
#include "NDPairList.h"
#include "CG_KDRChannelCompCategory.h"
#include <math.h>
//#define DEBUG_HH

KDRChannelCompCategory::KDRChannelCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_KDRChannelCompCategory(sim, modelName, ndpList)
{
}

void KDRChannelCompCategory::computeE_KDR(RNG& rng) 
{
...
void KDRChannelCompCategory::count() 
{
