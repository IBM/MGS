...
// =============================================================================
#include "Mgs.h"
#include "ChannelHaySKCompCategory.h"
#include "NDPairList.h"
#include "CG_ChannelHaySKCompCategory.h"
#include <math.h>
//#define DEBUG_HH

ChannelHaySKCompCategory::ChannelHaySKCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelHaySKCompCategory(sim, modelName, ndpList)
{
}

void ChannelHaySKCompCategory::computeE(RNG& rng) 
{
...
void ChannelHaySKCompCategory::count() 
{
  ...
  if (getSimulation().getRank()==0) printf("Total SK Channel = %lld, Mean = %lf, StDev = %lf\n", totalCount, mean, std);
}
