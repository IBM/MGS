...
#include "Lens.h"
#include "ChannelKv31_GPe_mouseCompCategory.h"
...
ChannelKv31_GPe_mouseCompCategory::ChannelKv31_GPe_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelKv31_GPe_mouseCompCategory(sim, modelName, ndpList)
{
}

void ChannelKv31_GPe_mouseCompCategory::computeE(RNG& rng) 
{
 // step 1.
...
void ChannelKv31_GPe_mouseCompCategory::count()
{
