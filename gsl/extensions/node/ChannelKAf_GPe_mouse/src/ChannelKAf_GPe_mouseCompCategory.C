...
#include "Mgs.h"
#include "ChannelKAf_GPe_mouseCompCategory.h"
...
ChannelKAf_GPe_mouseCompCategory::ChannelKAf_GPe_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelKAf_GPe_mouseCompCategory(sim, modelName, ndpList)
{
}
...
void ChannelKAf_GPe_mouseCompCategory::computeE(RNG& rng)
{
  // step 1.
...
void ChannelKAf_GPe_mouseCompCategory::count()
{
