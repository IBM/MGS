...
#include "Lens.h"
#include "ChannelNat_GPe_mouseCompCategory.h"
...
ChannelNat_GPe_mouseCompCategory::ChannelNat_GPe_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelNat_GPe_mouseCompCategory(sim, modelName, ndpList)
{
}

void ChannelNat_GPe_mouseCompCategory::computeE(RNG& rng) 
{
 // step 1.
...
void ChannelNat_GPe_mouseCompCategory::count()
{
