#include "Lens.h"
#include "ChannelBKalphabetaCompCategory.h"
...
ChannelBKalphabetaCompCategory::ChannelBKalphabetaCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelBKalphabetaCompCategory(sim, modelName, ndpList)
{
}
...
void ChannelBKalphabetaCompCategory::computeE(RNG& rng) 
{
  // step 1.
...
void ChannelBKalphabetaCompCategory::count()
{
