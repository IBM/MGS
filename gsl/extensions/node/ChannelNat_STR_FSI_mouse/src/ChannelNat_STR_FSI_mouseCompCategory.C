...
ChannelNat_STR_FSI_mouseCompCategory::ChannelNat_STR_FSI_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelNat_STR_FSI_mouseCompCategory(sim, modelName, ndpList)
{
}

void ChannelNat_STR_FSI_mouseCompCategory::computeE(RNG& rng) 
{
// step 1.
...
void ChannelNat_STR_FSI_mouseCompCategory::count()
{
