...
// =============================================================================
#include "Lens.h"
#include "KCaChannelCompCategory.h"
#include "NDPairList.h"
#include "CG_KCaChannelCompCategory.h"
#include <math.h>
//#define DEBUG_HH

KCaChannelCompCategory::KCaChannelCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_KCaChannelCompCategory(sim, modelName, ndpList)
{
}

void KCaChannelCompCategory::computeE_K(RNG& rng) 
{
...
void KCaChannelCompCategory::count() 
{
