...
// =============================================================================
#include "Lens.h"
#include "KDRChannel_IOCompCategory.h"
#include "NDPairList.h"
#include "CG_KDRChannel_IOCompCategory.h"
#include <math.h>
//#define DEBUG_HH

KDRChannel_IOCompCategory::KDRChannel_IOCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_KDRChannel_IOCompCategory(sim, modelName, ndpList)
{
}

void KDRChannel_IOCompCategory::computeE_KDR(RNG& rng) 
{
...
void KDRChannel_IOCompCategory::count() 
{
  ...
  if (getSimulation().getRank()==0) printf("Total KDR Channel_IO = %lld, Mean = %lf, StDev = %lf\n", totalCount, mean, std);
}
