...
// =============================================================================
#include "Lens.h"
#include "ChannelSchweighoferCahCompCategory.h"
#include "NDPairList.h"
#include "CG_ChannelSchweighoferCahCompCategory.h"
#include <math.h>
//#define DEBUG_HH

ChannelSchweighoferCahCompCategory::ChannelSchweighoferCahCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelSchweighoferCahCompCategory(sim, modelName, ndpList)
{
}

void ChannelSchweighoferCahCompCategory::count() 
{
  ...
  if (getSimulation().getRank()==0) printf("Total Cah Channel = %lld, Mean = %lf, StDev = %lf\n", totalCount, mean, std);
}
