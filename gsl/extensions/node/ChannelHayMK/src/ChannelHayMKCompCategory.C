...
// =============================================================================
#include "Mgs.h"
#include "ChannelHayMKCompCategory.h"
#include "NDPairList.h"
#include "CG_ChannelHayMKCompCategory.h"
#include <math.h>
//#define DEBUG_HH

ChannelHayMKCompCategory::ChannelHayMKCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelHayMKCompCategory(sim, modelName, ndpList)
{
}

void ChannelHayMKCompCategory::computeE(RNG& rng) 
{
...
void ChannelHayMKCompCategory::count() 
{
  ...
  if (getSimulation().getRank()==0) printf("Total MK Channel = %lld, Mean = %lf, StDev = %lf\n", totalCount, mean, std);
}
