...
#include "Lens.h"
#include "ChannelSchweighoferHCNCompCategory.h"
#include "NDPairList.h"
#include "CG_ChannelSchweighoferHCNCompCategory.h"
#include <math.h>
//#define DEBUG_HH

ChannelSchweighoferHCNCompCategory::ChannelSchweighoferHCNCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelSchweighoferHCNCompCategory(sim, modelName, ndpList)
{
}

void ChannelSchweighoferHCNCompCategory::count() 
{
