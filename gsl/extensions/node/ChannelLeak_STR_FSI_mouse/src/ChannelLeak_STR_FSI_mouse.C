...
#include "Lens.h"
#include "ChannelLeak_STR_FSI_mouse.h"
...
void ChannelLeak_STR_FSI_mouse::update(RNG& rng) 
{
...
void ChannelLeak_STR_FSI_mouse::initialize(RNG& rng) 
{
 assert(branchData);
...
ChannelLeak_STR_FSI_mouse::~ChannelLeak_STR_FSI_mouse() 
{
}
