...
// =============================================================================
#include "Lens.h"
#include "ChannelSchweighoferKDRCompCategory.h"
#include "NDPairList.h"
#include "CG_ChannelSchweighoferKDRCompCategory.h"
#include <math.h>
//#define DEBUG_HH

ChannelSchweighoferKDRCompCategory::ChannelSchweighoferKDRCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelSchweighoferKDRCompCategory(sim, modelName, ndpList)
{
}

void ChannelSchweighoferKDRCompCategory::computeE(RNG& rng) 
{
...
void ChannelSchweighoferKDRCompCategory::count() 
{
