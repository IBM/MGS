#include "Lens.h"
#include "ChannelKv31CompCategory.h"
...
ChannelKv31CompCategory::ChannelKv31CompCategory(Simulation& sim,
                                                 const std::string& modelName,
                                                 const NDPairList& ndpList)
    : CG_ChannelKv31CompCategory(sim, modelName, ndpList)
{
}
...
void ChannelKv31CompCategory::computeE(RNG& rng)
{
  // step 1.
...
void ChannelKv31CompCategory::count()
{
