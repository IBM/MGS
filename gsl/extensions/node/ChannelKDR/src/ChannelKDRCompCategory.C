...
// =============================================================================
#include "Lens.h"
#include "ChannelKDRCompCategory.h"
...
ChannelKDRCompCategory::ChannelKDRCompCategory(Simulation& sim,
    ...
    : CG_ChannelKDRCompCategory(sim, modelName, ndpList)
{
}
...
void ChannelKDRCompCategory::computeE(RNG& rng)
{
  // step 1.
...
void ChannelKDRCompCategory::count()
{
