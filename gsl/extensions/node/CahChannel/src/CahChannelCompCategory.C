...
// =============================================================================
#include "Lens.h"
#include "CahChannelCompCategory.h"
#include "NDPairList.h"
#include "CG_CahChannelCompCategory.h"
#include <math.h>
//#define DEBUG_HH

CahChannelCompCategory::CahChannelCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_CahChannelCompCategory(sim, modelName, ndpList)
{
}

void CahChannelCompCategory::count() 
{
