...
#include "Mgs.h"
#include "ChannelNap_GPe_mouseCompCategory.h"
...
ChannelNap_GPe_mouseCompCategory::ChannelNap_GPe_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelNap_GPe_mouseCompCategory(sim, modelName, ndpList)
{
}

void ChannelNap_GPe_mouseCompCategory::computeE(RNG& rng) 
{ // step 1.
...
void ChannelNap_GPe_mouseCompCategory::count()
{
