...
class mGluReceptorType1 : public CG_mGluReceptorType1
{
   public:
      ...
      virtual void setPrePostIndex(const String& CG_direction, const String& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_mGluReceptorType1InAttrPSet* CG_inAttrPset, CG_mGluReceptorType1OutAttrPSet* CG_outAttrPset);
