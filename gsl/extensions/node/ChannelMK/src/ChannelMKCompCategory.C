...
// =============================================================================
#include "Lens.h"
#include "ChannelMKCompCategory.h"
...
ChannelMKCompCategory::ChannelMKCompCategory(Simulation& sim,
                                             const std::string& modelName,
                                             const NDPairList& ndpList)
    : CG_ChannelMKCompCategory(sim, modelName, ndpList)
{
}
...
void ChannelMKCompCategory::computeE(RNG& rng)
{
  // step 1.
...
void ChannelMKCompCategory::count()
{
