...
// =============================================================================
#include "Mgs.h"
#include "ChannelCaLVACompCategory.h"
...
ChannelCaLVACompCategory::ChannelCaLVACompCategory(Simulation& sim,
                                                   const std::string& modelName,
                                                   const NDPairList& ndpList)
    : CG_ChannelCaLVACompCategory(sim, modelName, ndpList)
{
}

// GOAL:
//  2. find Q10 adjustment
void ChannelCaLVACompCategory::computeTadj(RNG& rng)
{
...
void ChannelCaLVACompCategory::count()
{
  ...
  if (getSimulation().getRank() == 0)
    printf("Total Ca_LVA Channel = %lld, Mean = %lf, StDev = %lf\n", totalCount,
           mean, std);
}
