...
void ChannelCaPQ_GHK::setPointers(const String& CG_direction, const String& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_ChannelCaPQ_GHKInAttrPSet* CG_inAttrPset, CG_ChannelCaPQ_GHKOutAttrPSet* CG_outAttrPset) 
{
