...
void ForwardSolvePoint4::setPointers(const String& CG_direction, const String& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_ForwardSolvePoint4InAttrPSet* CG_inAttrPset, CG_ForwardSolvePoint4OutAttrPSet* CG_outAttrPset) 
{
