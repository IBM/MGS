...
ChannelSKCompCategory::ChannelSKCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelSKCompCategory(sim, modelName, ndpList)
{
}
...
void ChannelSKCompCategory::computeE(RNG& rng) 
{
  // step 1.
...
void ChannelSKCompCategory::count()
{
