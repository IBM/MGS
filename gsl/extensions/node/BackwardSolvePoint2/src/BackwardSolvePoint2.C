...
void BackwardSolvePoint2::setPointers(const CustomString& CG_direction, const CustomString& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_BackwardSolvePoint2InAttrPSet* CG_inAttrPset, CG_BackwardSolvePoint2OutAttrPSet* CG_outAttrPset) 
{
