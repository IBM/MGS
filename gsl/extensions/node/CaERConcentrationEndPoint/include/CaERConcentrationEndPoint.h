...
class CaERConcentrationEndPoint : public CG_CaERConcentrationEndPoint
{
   public:
      ...
      virtual void setPointers(const String& CG_direction, const String& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_CaERConcentrationEndPointInAttrPSet* CG_inAttrPset, CG_CaERConcentrationEndPointOutAttrPSet* CG_outAttrPset);
