...
// =============================================================================
#include "Mgs.h"
#include "ChannelHayNatCompCategory.h"
#include "NDPairList.h"
#include "CG_ChannelHayNatCompCategory.h"
#include <math.h>
//#define DEBUG_HH

ChannelHayNatCompCategory::ChannelHayNatCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelHayNatCompCategory(sim, modelName, ndpList)
{
}

void ChannelHayNatCompCategory::computeE(RNG& rng) 
{
...
void ChannelHayNatCompCategory::count() 
{
