...
ChannelKAs_GPe_mouseCompCategory::ChannelKAs_GPe_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelKAs_GPe_mouseCompCategory(sim, modelName, ndpList)
{
}

void ChannelKAs_GPe_mouseCompCategory::computeE(RNG& rng) 
{
 // step 1.
...
void ChannelKAs_GPe_mouseCompCategory::count()
{
