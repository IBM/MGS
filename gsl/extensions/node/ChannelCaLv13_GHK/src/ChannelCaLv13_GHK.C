...
void ChannelCaLv13_GHK::update(RNG& rng) 
{
  ...
  {
    dyn_var_t v = (*V)[i];
#if CHANNEL_CaLv13 == CaLv13_WOLF_2005
...
void ChannelCaLv13_GHK::setPointers(const String& CG_direction, const String& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_ChannelCaLv13_GHKInAttrPSet* CG_inAttrPset, CG_ChannelCaLv13_GHKOutAttrPSet* CG_outAttrPset) 
{
