...
// =============================================================================
#include "Mgs.h"
#include "ForwardSolvePoint6.h"
#include "CG_ForwardSolvePoint6.h"
#include "rndm.h"

void ForwardSolvePoint6::produceInitialState(RNG& rng) 
{
}

void ForwardSolvePoint6::produceInitialCoefficients(RNG& rng) 
{
}

void ForwardSolvePoint6::produceForwardSolution(RNG& rng) 
{
}

void ForwardSolvePoint6::setPointers(const CustomString& CG_direction, const CustomString& CG_component, NodeDescriptor* CG_node, Edge* CG_edge, VariableDescriptor* CG_variable, Constant* CG_constant, CG_ForwardSolvePoint6InAttrPSet* CG_inAttrPset, CG_ForwardSolvePoint6OutAttrPSet* CG_outAttrPset) 
{
...
ForwardSolvePoint6::~ForwardSolvePoint6() 
{
}
