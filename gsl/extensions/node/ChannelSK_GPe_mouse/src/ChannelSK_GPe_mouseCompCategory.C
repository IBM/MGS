...
#include "Lens.h"
#include "ChannelSK_GPe_mouseCompCategory.h"
...
ChannelSK_GPe_mouseCompCategory::ChannelSK_GPe_mouseCompCategory(Simulation& sim, const std::string& modelName, const NDPairList& ndpList) 
   : CG_ChannelSK_GPe_mouseCompCategory(sim, modelName, ndpList)
{
}

void ChannelSK_GPe_mouseCompCategory::computeE(RNG& rng) 
{
 // step 1.
...
void ChannelSK_GPe_mouseCompCategory::count()
{
