...
UnsignedServiceTriggerDescriptor::UnsignedServiceTriggerDescriptor(Simulation& s)
: TriggerType("UnsignedServiceTrigger", "UnsignedServiceTrigger", 
...
Trigger* UnsignedServiceTriggerDescriptor::getTrigger(const std::vector<DataItem*>& args)
{
   Trigger* rval = new UnsignedServiceTrigger(_sim, args);
...
Trigger* UnsignedServiceTriggerDescriptor::getTrigger(NDPairList& ndp)
{
   Trigger* rval = 0;
   ...
   if(itr2 == end) {
      throw SyntaxErrorException("Service not found in UnsignedServiceTriggerDescriptor NDPList!");
   }
   else if(itr3 == end) {
      ...
      throw SyntaxErrorException("Delay not found in UnsignedServiceTriggerDescriptor NDPList!");
   }
   else {
	 ...
	 args.push_back((*itr)->getDataItem());
      ...
      rval = new UnsignedServiceTrigger(_sim, args);
      _triggerList.push_back(rval);
      TriggerDataItem* tdi = new TriggerDataItem;
      tdi->setTrigger(rval);
      _instances.push_back(tdi);
...
UnsignedServiceTriggerDescriptor::~UnsignedServiceTriggerDescriptor()
{
}
